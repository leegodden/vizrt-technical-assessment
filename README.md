...
The app is built using React and React hooks along with:

Axios npm package for fetching data from the api
React Bootstrap package for component elements
Export Table to Excel package for exporting the table to Excel
